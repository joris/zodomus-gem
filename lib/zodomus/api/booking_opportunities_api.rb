...
module Zodomus
  class BookingOpportunitiesApi
    ...
    def opportunities_get(channel_id, property_id, opts = {})
      data, _status_code, _headers = opportunities_get_with_http_info(channel_id, property_id, opts)
      data
    end
    ...
    # @param property_id [String] Property id supplied by the channel
    # @param [Hash] opts the optional parameters
    # @return [Array<(OpportunitiesResponse, Integer, Hash)>] OpportunitiesResponse data, response status code and response headers
    def opportunities_get_with_http_info(channel_id, property_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BookingOpportunitiesApi.opportunities_get ...'
      end
      # verify the required parameter 'channel_id' is set
      if @api_client.config.client_side_validation && channel_id.nil?
        fail ArgumentError, "Missing the required parameter 'channel_id' when calling BookingOpportunitiesApi.opportunities_get"
      end
      # verify the required parameter 'property_id' is set
      if @api_client.config.client_side_validation && property_id.nil?
        fail ArgumentError, "Missing the required parameter 'property_id' when calling BookingOpportunitiesApi.opportunities_get"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:return_type] || 'OpportunitiesResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BookingOpportunitiesApi#opportunities_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def opportunities_post(body, opts = {})
    ...
    def opportunities_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
