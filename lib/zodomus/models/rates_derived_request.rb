  ...
  class RatesDerivedRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zodomus::RatesDerivedRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zodomus::RatesDerivedRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'base_occupancy')
        self.base_occupancy = attributes[:'base_occupancy']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          base_occupancy == o.base_occupancy &&
    ...
    def hash
      [channel_id, property_id, room_id, rate_id, date_from, date_to, currency_code, base_occupancy, occupancy].hash
    end
