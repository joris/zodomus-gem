...
module Zodomus
  class PropertyActivationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zodomus::PropertyActivationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zodomus::PropertyActivationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'price_model_id')
        self.price_model_id = attributes[:'price_model_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @price_model_id.nil?
        invalid_properties.push('invalid value for "price_model_id", price_model_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @price_model_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          price_model_id == o.price_model_id
    end
    ...
    def hash
      [channel_id, property_id, price_model_id].hash
    end
