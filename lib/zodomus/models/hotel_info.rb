...
module Zodomus
  class HotelInfo
    attr_accessor :guest_room_quantity

    attr_accessor :property_type

    attr_accessor :services

    attr_accessor :accepted_payments

    attr_accessor :transportations

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'guest_room_quantity' => :'guestRoomQuantity',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zodomus::HotelInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zodomus::HotelInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'guest_room_quantity')
        self.guest_room_quantity = attributes[:'guest_room_quantity']
      end
      ...
      if attributes.key?(:'transportations')
        if (value = attributes[:'transportations']).is_a?(Array)
          self.transportations = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          guest_room_quantity == o.guest_room_quantity &&
    ...
    def hash
      [guest_room_quantity, property_type, services, accepted_payments, transportations].hash
    end
