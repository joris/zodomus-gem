...
# Unit tests for Zodomus::RoomR
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomR' do
  before do
    # run before each test
    @instance = Zodomus::RoomR.new
  end
  ...
  describe 'test an instance of RoomR' do
    it 'should create an instance of RoomR' do
      expect(@instance).to be_instance_of(Zodomus::RoomR)
    end
  end
  ...
  describe 'test attribute "meal_plan"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "price_details_extra"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
