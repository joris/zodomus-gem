...
# Unit tests for Zodomus::TpaExtensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TpaExtensions' do
  before do
    # run before each test
    @instance = Zodomus::TpaExtensions.new
  end
  ...
  describe 'test an instance of TpaExtensions' do
    it 'should create an instance of TpaExtensions' do
      expect(@instance).to be_instance_of(Zodomus::TpaExtensions)
    end
  end
  describe 'test attribute "sell_meals_through_booking"' do
    it 'should work' do
