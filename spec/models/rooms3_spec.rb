...
# Unit tests for Zodomus::Rooms3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Rooms3' do
  before do
    # run before each test
    @instance = Zodomus::Rooms3.new
  end
  ...
  describe 'test an instance of Rooms3' do
    it 'should create an instance of Rooms3' do
      expect(@instance).to be_instance_of(Zodomus::Rooms3)
    end
  end
  describe 'test attribute "roomid"' do
    it 'should work' do
