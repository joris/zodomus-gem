...
# Unit tests for Zodomus::RoomPrices
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomPrices' do
  before do
    # run before each test
    @instance = Zodomus::RoomPrices.new
  end
  ...
  describe 'test an instance of RoomPrices' do
    it 'should create an instance of RoomPrices' do
      expect(@instance).to be_instance_of(Zodomus::RoomPrices)
    end
  end
  ...
  describe 'test attribute "genius_rate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rewritten_from_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rewritten_from_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
