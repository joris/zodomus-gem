...
# Unit tests for Zodomus::Clean
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Clean' do
  before do
    # run before each test
    @instance = Zodomus::Clean.new
  end
  ...
  describe 'test an instance of Clean' do
    it 'should create an instance of Clean' do
      expect(@instance).to be_instance_of(Zodomus::Clean)
    end
  end
