...
# Unit tests for Zodomus::OpportunitiesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OpportunitiesResponse' do
  before do
    # run before each test
    @instance = Zodomus::OpportunitiesResponse.new
  end
  ...
  describe 'test an instance of OpportunitiesResponse' do
    it 'should create an instance of OpportunitiesResponse' do
      expect(@instance).to be_instance_of(Zodomus::OpportunitiesResponse)
    end
  end
