...
# Unit tests for Zodomus::Rooms1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Rooms1' do
  before do
    # run before each test
    @instance = Zodomus::Rooms1.new
  end
  ...
  describe 'test an instance of Rooms1' do
    it 'should create an instance of Rooms1' do
      expect(@instance).to be_instance_of(Zodomus::Rooms1)
    end
  end
