...
# Unit tests for Zodomus::Rooms2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Rooms2' do
  before do
    # run before each test
    @instance = Zodomus::Rooms2.new
  end
  ...
  describe 'test an instance of Rooms2' do
    it 'should create an instance of Rooms2' do
      expect(@instance).to be_instance_of(Zodomus::Rooms2)
    end
  end
