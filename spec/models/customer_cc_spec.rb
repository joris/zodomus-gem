...
# Unit tests for Zodomus::CustomerCC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerCC' do
  before do
    # run before each test
    @instance = Zodomus::CustomerCC.new
  end
  ...
  describe 'test an instance of CustomerCC' do
    it 'should create an instance of CustomerCC' do
      expect(@instance).to be_instance_of(Zodomus::CustomerCC)
    end
  end
