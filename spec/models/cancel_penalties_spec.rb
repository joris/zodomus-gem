...
# Unit tests for Zodomus::CancelPenalties
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CancelPenalties' do
  before do
    # run before each test
    @instance = Zodomus::CancelPenalties.new
  end
  ...
  describe 'test an instance of CancelPenalties' do
    it 'should create an instance of CancelPenalties' do
      expect(@instance).to be_instance_of(Zodomus::CancelPenalties)
    end
  end
  ...
  describe 'test attribute "policy_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
