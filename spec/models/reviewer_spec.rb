...
# Unit tests for Zodomus::Reviewer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Reviewer' do
  before do
    # run before each test
    @instance = Zodomus::Reviewer.new
  end
  ...
  describe 'test an instance of Reviewer' do
    it 'should create an instance of Reviewer' do
      expect(@instance).to be_instance_of(Zodomus::Reviewer)
    end
  end
  ...
  describe 'test attribute "is_genius"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
