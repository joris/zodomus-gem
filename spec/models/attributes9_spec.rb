...
# Unit tests for Zodomus::Attributes9
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Attributes9' do
  before do
    # run before each test
    @instance = Zodomus::Attributes9.new
  end
  ...
  describe 'test an instance of Attributes9' do
    it 'should create an instance of Attributes9' do
      expect(@instance).to be_instance_of(Zodomus::Attributes9)
    end
  end
