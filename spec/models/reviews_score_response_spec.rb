...
# Unit tests for Zodomus::ReviewsScoreResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReviewsScoreResponse' do
  before do
    # run before each test
    @instance = Zodomus::ReviewsScoreResponse.new
  end
  ...
  describe 'test an instance of ReviewsScoreResponse' do
    it 'should create an instance of ReviewsScoreResponse' do
      expect(@instance).to be_instance_of(Zodomus::ReviewsScoreResponse)
    end
  end
  ...
  describe 'test attribute "reviews_scores"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
