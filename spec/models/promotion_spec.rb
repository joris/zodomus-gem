...
# Unit tests for Zodomus::Promotion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Promotion' do
  before do
    # run before each test
    @instance = Zodomus::Promotion.new
  end
  ...
  describe 'test an instance of Promotion' do
    it 'should create an instance of Promotion' do
      expect(@instance).to be_instance_of(Zodomus::Promotion)
    end
  end
  ...
  describe 'test attribute "early_boker"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
