...
# Unit tests for Zodomus::ActiveWeekdays1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ActiveWeekdays1' do
  before do
    # run before each test
    @instance = Zodomus::ActiveWeekdays1.new
  end
  ...
  describe 'test an instance of ActiveWeekdays1' do
    it 'should create an instance of ActiveWeekdays1' do
      expect(@instance).to be_instance_of(Zodomus::ActiveWeekdays1)
    end
  end
  describe 'test attribute "active_weekday"' do
    it 'should work' do
