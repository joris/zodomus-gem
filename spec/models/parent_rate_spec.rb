...
# Unit tests for Zodomus::ParentRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParentRate' do
  before do
    # run before each test
    @instance = Zodomus::ParentRate.new
  end
  ...
  describe 'test an instance of ParentRate' do
    it 'should create an instance of ParentRate' do
      expect(@instance).to be_instance_of(Zodomus::ParentRate)
    end
  end
