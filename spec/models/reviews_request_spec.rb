...
# Unit tests for Zodomus::ReviewsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReviewsRequest' do
  before do
    # run before each test
    @instance = Zodomus::ReviewsRequest.new
  end
  ...
  describe 'test an instance of ReviewsRequest' do
    it 'should create an instance of ReviewsRequest' do
      expect(@instance).to be_instance_of(Zodomus::ReviewsRequest)
    end
  end
  ...
  describe 'test attribute "reviews_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
