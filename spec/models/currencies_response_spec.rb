...
# Unit tests for Zodomus::CurrenciesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CurrenciesResponse' do
  before do
    # run before each test
    @instance = Zodomus::CurrenciesResponse.new
  end
  ...
  describe 'test an instance of CurrenciesResponse' do
    it 'should create an instance of CurrenciesResponse' do
      expect(@instance).to be_instance_of(Zodomus::CurrenciesResponse)
    end
  end
