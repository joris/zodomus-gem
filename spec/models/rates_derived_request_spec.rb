...
# Unit tests for Zodomus::RatesDerivedRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RatesDerivedRequest' do
  before do
    # run before each test
    @instance = Zodomus::RatesDerivedRequest.new
  end
  ...
  describe 'test an instance of RatesDerivedRequest' do
    it 'should create an instance of RatesDerivedRequest' do
      expect(@instance).to be_instance_of(Zodomus::RatesDerivedRequest)
    end
  end
  ...
  describe 'test attribute "base_occupancy"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
