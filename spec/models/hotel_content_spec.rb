...
# Unit tests for Zodomus::HotelContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HotelContent' do
  before do
    # run before each test
    @instance = Zodomus::HotelContent.new
  end
  ...
  describe 'test an instance of HotelContent' do
    it 'should create an instance of HotelContent' do
      expect(@instance).to be_instance_of(Zodomus::HotelContent)
    end
  end
  ...
  describe 'test attribute "property_license_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
