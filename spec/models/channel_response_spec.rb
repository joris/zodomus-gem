...
# Unit tests for Zodomus::ChannelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ChannelResponse' do
  before do
    # run before each test
    @instance = Zodomus::ChannelResponse.new
  end
  ...
  describe 'test an instance of ChannelResponse' do
    it 'should create an instance of ChannelResponse' do
      expect(@instance).to be_instance_of(Zodomus::ChannelResponse)
    end
  end
