...
# Unit tests for Zodomus::GuestReviewsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'GuestReviewsResponse' do
  before do
    # run before each test
    @instance = Zodomus::GuestReviewsResponse.new
  end
  ...
  describe 'test an instance of GuestReviewsResponse' do
    it 'should create an instance of GuestReviewsResponse' do
      expect(@instance).to be_instance_of(Zodomus::GuestReviewsResponse)
    end
  end
