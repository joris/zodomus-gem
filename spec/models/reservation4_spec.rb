...
# Unit tests for Zodomus::Reservation4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Reservation4' do
  before do
    # run before each test
    @instance = Zodomus::Reservation4.new
  end
  ...
  describe 'test an instance of Reservation4' do
    it 'should create an instance of Reservation4' do
      expect(@instance).to be_instance_of(Zodomus::Reservation4)
    end
  end
