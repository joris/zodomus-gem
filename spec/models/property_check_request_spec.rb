...
# Unit tests for Zodomus::PropertyCheckRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyCheckRequest' do
  before do
    # run before each test
    @instance = Zodomus::PropertyCheckRequest.new
  end
  ...
  describe 'test an instance of PropertyCheckRequest' do
    it 'should create an instance of PropertyCheckRequest' do
      expect(@instance).to be_instance_of(Zodomus::PropertyCheckRequest)
    end
  end
