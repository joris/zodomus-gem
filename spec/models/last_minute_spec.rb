...
# Unit tests for Zodomus::LastMinute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LastMinute' do
  before do
    # run before each test
    @instance = Zodomus::LastMinute.new
  end
  ...
  describe 'test an instance of LastMinute' do
    it 'should create an instance of LastMinute' do
      expect(@instance).to be_instance_of(Zodomus::LastMinute)
    end
  end
