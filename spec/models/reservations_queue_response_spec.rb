...
# Unit tests for Zodomus::ReservationsQueueResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationsQueueResponse' do
  before do
    # run before each test
    @instance = Zodomus::ReservationsQueueResponse.new
  end
  ...
  describe 'test an instance of ReservationsQueueResponse' do
    it 'should create an instance of ReservationsQueueResponse' do
      expect(@instance).to be_instance_of(Zodomus::ReservationsQueueResponse)
    end
  end
