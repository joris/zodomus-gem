...
# Unit tests for Zodomus::ParentRates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParentRates' do
  before do
    # run before each test
    @instance = Zodomus::ParentRates.new
  end
  ...
  describe 'test an instance of ParentRates' do
    it 'should create an instance of ParentRates' do
      expect(@instance).to be_instance_of(Zodomus::ParentRates)
    end
  end
  describe 'test attribute "parent_rate"' do
    it 'should work' do
