...
# Unit tests for Zodomus::Comfort
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Comfort' do
  before do
    # run before each test
    @instance = Zodomus::Comfort.new
  end
  ...
  describe 'test an instance of Comfort' do
    it 'should create an instance of Comfort' do
      expect(@instance).to be_instance_of(Zodomus::Comfort)
    end
  end
