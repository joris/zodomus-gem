...
# Unit tests for Zodomus::ReportingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReportingRequest' do
  before do
    # run before each test
    @instance = Zodomus::ReportingRequest.new
  end
  ...
  describe 'test an instance of ReportingRequest' do
    it 'should create an instance of ReportingRequest' do
      expect(@instance).to be_instance_of(Zodomus::ReportingRequest)
    end
  end
