...
# Unit tests for Zodomus::Attributes3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Attributes3' do
  before do
    # run before each test
    @instance = Zodomus::Attributes3.new
  end
  ...
  describe 'test an instance of Attributes3' do
    it 'should create an instance of Attributes3' do
      expect(@instance).to be_instance_of(Zodomus::Attributes3)
    end
  end
