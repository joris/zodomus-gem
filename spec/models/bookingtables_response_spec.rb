...
# Unit tests for Zodomus::BookingtablesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BookingtablesResponse' do
  before do
    # run before each test
    @instance = Zodomus::BookingtablesResponse.new
  end
  ...
  describe 'test an instance of BookingtablesResponse' do
    it 'should create an instance of BookingtablesResponse' do
      expect(@instance).to be_instance_of(Zodomus::BookingtablesResponse)
    end
  end
