...
# Unit tests for Zodomus::Bookingtables
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Bookingtables' do
  before do
    # run before each test
    @instance = Zodomus::Bookingtables.new
  end
  ...
  describe 'test an instance of Bookingtables' do
    it 'should create an instance of Bookingtables' do
      expect(@instance).to be_instance_of(Zodomus::Bookingtables)
    end
  end
