...
# Unit tests for Zodomus::AdditionalDates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdditionalDates' do
  before do
    # run before each test
    @instance = Zodomus::AdditionalDates.new
  end
  ...
  describe 'test an instance of AdditionalDates' do
    it 'should create an instance of AdditionalDates' do
      expect(@instance).to be_instance_of(Zodomus::AdditionalDates)
    end
  end
