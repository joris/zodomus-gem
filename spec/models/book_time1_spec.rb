...
# Unit tests for Zodomus::BookTime1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BookTime1' do
  before do
    # run before each test
    @instance = Zodomus::BookTime1.new
  end
  ...
  describe 'test an instance of BookTime1' do
    it 'should create an instance of BookTime1' do
      expect(@instance).to be_instance_of(Zodomus::BookTime1)
    end
  end
