...
# Unit tests for Zodomus::ReservationsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationsResponse' do
  before do
    # run before each test
    @instance = Zodomus::ReservationsResponse.new
  end
  ...
  describe 'test an instance of ReservationsResponse' do
    it 'should create an instance of ReservationsResponse' do
      expect(@instance).to be_instance_of(Zodomus::ReservationsResponse)
    end
  end
