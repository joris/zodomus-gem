...
# Unit tests for Zodomus::Rooms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Rooms' do
  before do
    # run before each test
    @instance = Zodomus::Rooms.new
  end
  ...
  describe 'test an instance of Rooms' do
    it 'should create an instance of Rooms' do
      expect(@instance).to be_instance_of(Zodomus::Rooms)
    end
  end
