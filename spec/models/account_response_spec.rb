...
# Unit tests for Zodomus::AccountResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountResponse' do
  before do
    # run before each test
    @instance = Zodomus::AccountResponse.new
  end
  ...
  describe 'test an instance of AccountResponse' do
    it 'should create an instance of AccountResponse' do
      expect(@instance).to be_instance_of(Zodomus::AccountResponse)
    end
  end
