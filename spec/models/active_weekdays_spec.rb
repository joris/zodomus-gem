...
# Unit tests for Zodomus::ActiveWeekdays
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ActiveWeekdays' do
  before do
    # run before each test
    @instance = Zodomus::ActiveWeekdays.new
  end
  ...
  describe 'test an instance of ActiveWeekdays' do
    it 'should create an instance of ActiveWeekdays' do
      expect(@instance).to be_instance_of(Zodomus::ActiveWeekdays)
    end
  end
