...
# Unit tests for Zodomus::OpportunitiesRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OpportunitiesRequest' do
  before do
    # run before each test
    @instance = Zodomus::OpportunitiesRequest.new
  end
  ...
  describe 'test an instance of OpportunitiesRequest' do
    it 'should create an instance of OpportunitiesRequest' do
      expect(@instance).to be_instance_of(Zodomus::OpportunitiesRequest)
    end
  end
