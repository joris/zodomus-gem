...
# Unit tests for Zodomus::Room1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Room1' do
  before do
    # run before each test
    @instance = Zodomus::Room1.new
  end
  ...
  describe 'test an instance of Room1' do
    it 'should create an instance of Room1' do
      expect(@instance).to be_instance_of(Zodomus::Room1)
    end
  end
