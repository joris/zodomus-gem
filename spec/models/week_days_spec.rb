...
# Unit tests for Zodomus::WeekDays
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WeekDays' do
  before do
    # run before each test
    @instance = Zodomus::WeekDays.new
  end
  ...
  describe 'test an instance of WeekDays' do
    it 'should create an instance of WeekDays' do
      expect(@instance).to be_instance_of(Zodomus::WeekDays)
    end
  end
