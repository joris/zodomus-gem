...
# Unit tests for Zodomus::Transportation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Transportation' do
  before do
    # run before each test
    @instance = Zodomus::Transportation.new
  end
  ...
  describe 'test an instance of Transportation' do
    it 'should create an instance of Transportation' do
      expect(@instance).to be_instance_of(Zodomus::Transportation)
    end
  end
