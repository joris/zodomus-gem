...
# Unit tests for Zodomus::ReviewScore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReviewScore' do
  before do
    # run before each test
    @instance = Zodomus::ReviewScore.new
  end
  ...
  describe 'test an instance of ReviewScore' do
    it 'should create an instance of ReviewScore' do
      expect(@instance).to be_instance_of(Zodomus::ReviewScore)
    end
  end
