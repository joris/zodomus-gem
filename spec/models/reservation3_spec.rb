...
# Unit tests for Zodomus::Reservation3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Reservation3' do
  before do
    # run before each test
    @instance = Zodomus::Reservation3.new
  end
  ...
  describe 'test an instance of Reservation3' do
    it 'should create an instance of Reservation3' do
      expect(@instance).to be_instance_of(Zodomus::Reservation3)
    end
  end
