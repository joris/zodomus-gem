...
# Unit tests for Zodomus::BookDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BookDate' do
  before do
    # run before each test
    @instance = Zodomus::BookDate.new
  end
  ...
  describe 'test an instance of BookDate' do
    it 'should create an instance of BookDate' do
      expect(@instance).to be_instance_of(Zodomus::BookDate)
    end
  end
