...
# Unit tests for Zodomus::Reservation2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Reservation2' do
  before do
    # run before each test
    @instance = Zodomus::Reservation2.new
  end
  ...
  describe 'test an instance of Reservation2' do
    it 'should create an instance of Reservation2' do
      expect(@instance).to be_instance_of(Zodomus::Reservation2)
    end
  end
  ...
  describe 'test attribute "customer_cc"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
