...
# Unit tests for Zodomus::Attributes6
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Attributes6' do
  before do
    # run before each test
    @instance = Zodomus::Attributes6.new
  end
  ...
  describe 'test an instance of Attributes6' do
    it 'should create an instance of Attributes6' do
      expect(@instance).to be_instance_of(Zodomus::Attributes6)
    end
  end
