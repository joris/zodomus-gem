...
# Unit tests for Zodomus::TotalRevenue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TotalRevenue' do
  before do
    # run before each test
    @instance = Zodomus::TotalRevenue.new
  end
  ...
  describe 'test an instance of TotalRevenue' do
    it 'should create an instance of TotalRevenue' do
      expect(@instance).to be_instance_of(Zodomus::TotalRevenue)
    end
  end
