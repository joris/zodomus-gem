...
# Unit tests for Zodomus::MultimediaDescription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MultimediaDescription' do
  before do
    # run before each test
    @instance = Zodomus::MultimediaDescription.new
  end
  ...
  describe 'test an instance of MultimediaDescription' do
    it 'should create an instance of MultimediaDescription' do
      expect(@instance).to be_instance_of(Zodomus::MultimediaDescription)
    end
  end
