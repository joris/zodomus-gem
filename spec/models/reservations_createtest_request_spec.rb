...
# Unit tests for Zodomus::ReservationsCreatetestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationsCreatetestRequest' do
  before do
    # run before each test
    @instance = Zodomus::ReservationsCreatetestRequest.new
  end
  ...
  describe 'test an instance of ReservationsCreatetestRequest' do
    it 'should create an instance of ReservationsCreatetestRequest' do
      expect(@instance).to be_instance_of(Zodomus::ReservationsCreatetestRequest)
    end
  end
