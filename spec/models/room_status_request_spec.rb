...
# Unit tests for Zodomus::RoomStatusRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomStatusRequest' do
  before do
    # run before each test
    @instance = Zodomus::RoomStatusRequest.new
  end
  ...
  describe 'test an instance of RoomStatusRequest' do
    it 'should create an instance of RoomStatusRequest' do
      expect(@instance).to be_instance_of(Zodomus::RoomStatusRequest)
    end
  end
