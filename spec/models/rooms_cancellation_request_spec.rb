...
# Unit tests for Zodomus::RoomsCancellationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomsCancellationRequest' do
  before do
    # run before each test
    @instance = Zodomus::RoomsCancellationRequest.new
  end
  ...
  describe 'test an instance of RoomsCancellationRequest' do
    it 'should create an instance of RoomsCancellationRequest' do
      expect(@instance).to be_instance_of(Zodomus::RoomsCancellationRequest)
    end
  end
