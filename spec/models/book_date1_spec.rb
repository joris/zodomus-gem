...
# Unit tests for Zodomus::BookDate1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BookDate1' do
  before do
    # run before each test
    @instance = Zodomus::BookDate1.new
  end
  ...
  describe 'test an instance of BookDate1' do
    it 'should create an instance of BookDate1' do
      expect(@instance).to be_instance_of(Zodomus::BookDate1)
    end
  end
