...
# Unit tests for Zodomus::ReservationsSummaryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationsSummaryResponse' do
  before do
    # run before each test
    @instance = Zodomus::ReservationsSummaryResponse.new
  end
  ...
  describe 'test an instance of ReservationsSummaryResponse' do
    it 'should create an instance of ReservationsSummaryResponse' do
      expect(@instance).to be_instance_of(Zodomus::ReservationsSummaryResponse)
    end
  end
  ...
  describe 'test attribute "reservations"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
