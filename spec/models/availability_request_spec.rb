...
# Unit tests for Zodomus::AvailabilityRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AvailabilityRequest' do
  before do
    # run before each test
    @instance = Zodomus::AvailabilityRequest.new
  end
  ...
  describe 'test an instance of AvailabilityRequest' do
    it 'should create an instance of AvailabilityRequest' do
      expect(@instance).to be_instance_of(Zodomus::AvailabilityRequest)
    end
  end
