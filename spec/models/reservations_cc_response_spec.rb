...
# Unit tests for Zodomus::ReservationsCCResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservationsCCResponse' do
  before do
    # run before each test
    @instance = Zodomus::ReservationsCCResponse.new
  end
  ...
  describe 'test an instance of ReservationsCCResponse' do
    it 'should create an instance of ReservationsCCResponse' do
      expect(@instance).to be_instance_of(Zodomus::ReservationsCCResponse)
    end
  end
