...
# Unit tests for Zodomus::AreaInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AreaInfo' do
  before do
    # run before each test
    @instance = Zodomus::AreaInfo.new
  end
  ...
  describe 'test an instance of AreaInfo' do
    it 'should create an instance of AreaInfo' do
      expect(@instance).to be_instance_of(Zodomus::AreaInfo)
    end
  end
