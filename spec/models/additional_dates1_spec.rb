...
# Unit tests for Zodomus::AdditionalDates1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdditionalDates1' do
  before do
    # run before each test
    @instance = Zodomus::AdditionalDates1.new
  end
  ...
  describe 'test an instance of AdditionalDates1' do
    it 'should create an instance of AdditionalDates1' do
      expect(@instance).to be_instance_of(Zodomus::AdditionalDates1)
    end
  end
