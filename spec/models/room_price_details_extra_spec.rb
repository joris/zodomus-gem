...
# Unit tests for Zodomus::RoomPriceDetailsExtra
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomPriceDetailsExtra' do
  before do
    # run before each test
    @instance = Zodomus::RoomPriceDetailsExtra.new
  end
  ...
  describe 'test an instance of RoomPriceDetailsExtra' do
    it 'should create an instance of RoomPriceDetailsExtra' do
      expect(@instance).to be_instance_of(Zodomus::RoomPriceDetailsExtra)
    end
  end
  ...
  describe 'test attribute "per_night"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "per_person"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
