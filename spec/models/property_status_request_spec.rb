...
# Unit tests for Zodomus::PropertyStatusRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyStatusRequest' do
  before do
    # run before each test
    @instance = Zodomus::PropertyStatusRequest.new
  end
  ...
  describe 'test an instance of PropertyStatusRequest' do
    it 'should create an instance of PropertyStatusRequest' do
      expect(@instance).to be_instance_of(Zodomus::PropertyStatusRequest)
    end
  end
