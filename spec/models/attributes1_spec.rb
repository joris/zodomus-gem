...
# Unit tests for Zodomus::Attributes1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Attributes1' do
  before do
    # run before each test
    @instance = Zodomus::Attributes1.new
  end
  ...
  describe 'test an instance of Attributes1' do
    it 'should create an instance of Attributes1' do
      expect(@instance).to be_instance_of(Zodomus::Attributes1)
    end
  end
