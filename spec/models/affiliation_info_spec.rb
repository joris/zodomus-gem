...
# Unit tests for Zodomus::AffiliationInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AffiliationInfo' do
  before do
    # run before each test
    @instance = Zodomus::AffiliationInfo.new
  end
  ...
  describe 'test an instance of AffiliationInfo' do
    it 'should create an instance of AffiliationInfo' do
      expect(@instance).to be_instance_of(Zodomus::AffiliationInfo)
    end
  end
