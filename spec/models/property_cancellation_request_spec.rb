...
# Unit tests for Zodomus::PropertyCancellationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyCancellationRequest' do
  before do
    # run before each test
    @instance = Zodomus::PropertyCancellationRequest.new
  end
  ...
  describe 'test an instance of PropertyCancellationRequest' do
    it 'should create an instance of PropertyCancellationRequest' do
      expect(@instance).to be_instance_of(Zodomus::PropertyCancellationRequest)
    end
  end
