...
# Unit tests for Zodomus::BookTime
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BookTime' do
  before do
    # run before each test
    @instance = Zodomus::BookTime.new
  end
  ...
  describe 'test an instance of BookTime' do
    it 'should create an instance of BookTime' do
      expect(@instance).to be_instance_of(Zodomus::BookTime)
    end
  end
