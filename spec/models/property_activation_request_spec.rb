...
# Unit tests for Zodomus::PropertyActivationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PropertyActivationRequest' do
  before do
    # run before each test
    @instance = Zodomus::PropertyActivationRequest.new
  end
  ...
  describe 'test an instance of PropertyActivationRequest' do
    it 'should create an instance of PropertyActivationRequest' do
      expect(@instance).to be_instance_of(Zodomus::PropertyActivationRequest)
    end
  end
  ...
  describe 'test attribute "price_model_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
