...
# Unit tests for Zodomus::ExpediatablesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpediatablesResponse' do
  before do
    # run before each test
    @instance = Zodomus::ExpediatablesResponse.new
  end
  ...
  describe 'test an instance of ExpediatablesResponse' do
    it 'should create an instance of ExpediatablesResponse' do
      expect(@instance).to be_instance_of(Zodomus::ExpediatablesResponse)
    end
  end
