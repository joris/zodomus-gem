...
# Unit tests for Zodomus::ReviewsScore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReviewsScore' do
  before do
    # run before each test
    @instance = Zodomus::ReviewsScore.new
  end
  ...
  describe 'test an instance of ReviewsScore' do
    it 'should create an instance of ReviewsScore' do
      expect(@instance).to be_instance_of(Zodomus::ReviewsScore)
    end
  end
