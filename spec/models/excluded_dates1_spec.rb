...
# Unit tests for Zodomus::ExcludedDates1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExcludedDates1' do
  before do
    # run before each test
    @instance = Zodomus::ExcludedDates1.new
  end
  ...
  describe 'test an instance of ExcludedDates1' do
    it 'should create an instance of ExcludedDates1' do
      expect(@instance).to be_instance_of(Zodomus::ExcludedDates1)
    end
  end
