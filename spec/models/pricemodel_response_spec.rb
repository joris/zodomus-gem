...
# Unit tests for Zodomus::PricemodelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PricemodelResponse' do
  before do
    # run before each test
    @instance = Zodomus::PricemodelResponse.new
  end
  ...
  describe 'test an instance of PricemodelResponse' do
    it 'should create an instance of PricemodelResponse' do
      expect(@instance).to be_instance_of(Zodomus::PricemodelResponse)
    end
  end
