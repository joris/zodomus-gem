...
# Unit tests for Zodomus::FacilityInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FacilityInfo' do
  before do
    # run before each test
    @instance = Zodomus::FacilityInfo.new
  end
  ...
  describe 'test an instance of FacilityInfo' do
    it 'should create an instance of FacilityInfo' do
      expect(@instance).to be_instance_of(Zodomus::FacilityInfo)
    end
  end
  describe 'test attribute "guest_rooms"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "restaurants"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
