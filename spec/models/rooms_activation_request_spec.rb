...
# Unit tests for Zodomus::RoomsActivationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomsActivationRequest' do
  before do
    # run before each test
    @instance = Zodomus::RoomsActivationRequest.new
  end
  ...
  describe 'test an instance of RoomsActivationRequest' do
    it 'should create an instance of RoomsActivationRequest' do
      expect(@instance).to be_instance_of(Zodomus::RoomsActivationRequest)
    end
  end
