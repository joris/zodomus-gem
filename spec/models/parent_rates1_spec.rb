...
# Unit tests for Zodomus::ParentRates1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParentRates1' do
  before do
    # run before each test
    @instance = Zodomus::ParentRates1.new
  end
  ...
  describe 'test an instance of ParentRates1' do
    it 'should create an instance of ParentRates1' do
      expect(@instance).to be_instance_of(Zodomus::ParentRates1)
    end
  end
  describe 'test attribute "parent_rateid"' do
    it 'should work' do
