...
# Unit tests for Zodomus::RoomRatesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoomRatesResponse' do
  before do
    # run before each test
    @instance = Zodomus::RoomRatesResponse.new
  end
  ...
  describe 'test an instance of RoomRatesResponse' do
    it 'should create an instance of RoomRatesResponse' do
      expect(@instance).to be_instance_of(Zodomus::RoomRatesResponse)
    end
  end
